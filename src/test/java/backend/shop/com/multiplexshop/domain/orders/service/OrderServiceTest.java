...
class OrderServiceTest {
    ...
    @Test
    @DisplayName("동일한 상품을 1개씩 주문하여 동시에 100번 요청하였을 때 상품의 재고수량이 0이여야한다.")
    public void saveWithPessimisticLock() throws InterruptedException {
        //given
        Products products1 = Products.builder()
                .productName("향수")
                .productPrice(10000)
                ...
                .categories(Categories.STUFF)
                .build();
        productsRepository.saveAndFlush(products1);
        ...
        latch.await();
        //then
        Products result = productsRepository.findById(1L).orElse(null);
    ...
    public void test() throws InterruptedException {
        ...
        Products products1 = Products.builder()
                ...
                .categories(Categories.STUFF)
                .build();
        Products savedStuff = productsRepository.saveAndFlush(products1);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            OrderProducts orderProducts = OrderProducts.createOrderProducts(savedOrder, savedStuff, 1);
